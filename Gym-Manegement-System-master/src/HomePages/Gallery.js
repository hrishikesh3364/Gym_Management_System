...
import v1 from '../images/wp8834115.jpg';
const Gallery= () => {
    return (
       <>
       <div >
        
       <Image src= {v1} width= "100%" height="400px"  /> 
       </div>
      ...
      <Container style={{marginTop:'120px',marginRight:'10px'}}>
        <Row >
      ...
      <Container style={{marginTop:'120px',marginRight:'10px'}}>
        <Row >
          ...
          <Col><Image src= {gallery4} width= "100%"  height="235px" /></Col>
        </Row>
      </Container>
