...
return (
  <div style={{ backgroundColor: '#f0f0f0 #211545', minHeight: '100vh' }}>
  <div className="container" style={{ padding: '200px', maxWidth: '1000px' }}>
      <div className="card" style={{ color: 'black', backgroundColor: 'skyblue' }}>
          <h1 className="text-center" style={{ color: 'black', backgroundColor: '#f0f0f0', padding: '20px' }}>Member Sign-In</h1>
          <div className="card-body">
              <div className="mb-3">
                  <label>Email</label>
                  <input value={Email} name="Email" onChange={(event) => { setEmail(event.target.value) }} className="form-control" type="email" placeholder="Enter email" />
              </div>

              <div className="mb-3">
                  <label>Password</label>
                  <input value={Password} name="Password" onChange={(event) => { setPassword(event.target.value) }} className="form-control" type="password" placeholder="Enter password" />
              </div>
